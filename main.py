...
class PredictionInput(BaseModel):
    # Field constraint to prevent DoS via unbounded collection
...
def get_github_repos():
    ...
    try:
        ...
        return {"repositories": [repo["name"] for repo in repositories if isinstance(repo, dict) and "name" in repo]}
