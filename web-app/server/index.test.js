...
describe('Personal AI Platform API', () => {
  beforeEach(() => {
    process.env = { ...originalEnv, DISCORD_WEBHOOK_URL: 'http://discord.webhook.url', GITHUB_TOKEN: 'github-test-token', SLACK_BOT_TOKEN: 'slack-test-token', API_KEY: 'test-api-key' };
