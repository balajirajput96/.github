...
type AsButtonProps = BaseButtonProps & Omit<HTMLMotionProps<"button">, keyof BaseButtonProps> & {
  href?: never;
};

type AsAnchorProps = BaseButtonProps & Omit<HTMLMotionProps<"a">, keyof BaseButtonProps> & {
  href: string;
};
