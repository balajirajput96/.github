...
export function TerminalPreview() {
  ...
  useEffect(() => {
    ...
    // Total animation time = typing time + wait time
    // Typing time = fullText.length * 0.1s (100ms per char)
    // Wait time = 1.5s (1500ms)
    const animationDuration = (fullText.length * 100) + 1500;
