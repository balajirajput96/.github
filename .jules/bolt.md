...
## 2025-02-14 - Cache static file reads in loops
**Learning:** Reading static files repeatedly inside a processing loop causes unnecessary and redundant disk I/O bottlenecks.
**Action:** Use decorators like `@functools.lru_cache` on functions that read static content from disk to turn O(N) disk I/O operations into O(1), improving overall loop performance.
